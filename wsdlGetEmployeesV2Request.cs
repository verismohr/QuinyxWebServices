...
[MessageContract(WrapperName = "wsdlGetEmployeesV2", WrapperNamespace = "uri:FlexForce", IsWrapped = true)]
public class wsdlGetEmployeesV2Request
{
	...
	public wsdlGetEmployeesV2Request(string apiKey, int sectionId, int employeeId, string badgeNo, string lastModified, bool includeNeoRoles, int[] neoRolesIds, string[] neoExtRolesIds)
	{
		this.apiKey = apiKey;
