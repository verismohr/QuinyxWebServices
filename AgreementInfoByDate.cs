...
public class AgreementInfoByDate
{
    ...
    {
        get { return agreementUnitIdField; }
        set { agreementUnitIdField = value; }
    }

    public string agreementUnitName
    {
        get { return agreementUnitNameField; }
        set { agreementUnitNameField = value; }
    }
    ...
    {
        get { return agreementTemplateNameField; }
        set { agreementTemplateNameField = value; }
    }

    public decimal employmentRate
    {
        get { return employmentRateField; }
        set { employmentRateField = value; }
    }

    public decimal additionByWorkedYears
    {
        get { return additionByWorkedYearsField; }
        set { additionByWorkedYearsField = value; }
    }

    public decimal additionByAge
    {
        get { return additionByAgeField; }
        set { additionByAgeField = value; }
    }

    public decimal additionByPersonalAdjustment
    {
        get { return additionByPersonalAdjustmentField; }
        set { additionByPersonalAdjustmentField = value; }
    }
    ...
    {
        get { return calculatedSalaryField; }
        set { calculatedSalaryField = value; }
    }
}
