...
public class UnitKeyV2
{
    ...
    {
        get { return companyNoField; }
        set { companyNoField = value; }
    }

    public int districtGroupId
    {
        get { return districtGroupIdField; }
        set { districtGroupIdField = value; }
    }

    [SoapIgnore]
    public bool districtGroupIdSpecified
    {
        get { return districtGroupIdFieldSpecified; }
        set { districtGroupIdFieldSpecified = value; }
    }

    public string districtExtGroupId
    {
        get { return districtExtGroupIdField; }
        set { districtExtGroupIdField = value; }
    }
