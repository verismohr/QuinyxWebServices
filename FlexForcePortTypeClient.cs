...
public class FlexForcePortTypeClient : ClientBase<FlexForcePortType>, FlexForcePortType
{
	...
	public wsdlGetRestaurantsAPIKeyResponse wsdlGetRestaurantsAPIKey(wsdlGetRestaurantsAPIKeyRequest request)
	{
	...
	public wsdlGetResultTransferToPayrollResponse wsdlGetResultTransferToPayroll(wsdlGetResultTransferToPayrollRequest request)
	{
		return base.Channel.wsdlGetResultTransferToPayroll(request);
	}

	public wsdlInitiateTransferToPayrollResponse wsdlInitiateTransferToPayroll(wsdlInitiateTransferToPayrollRequest request)
	{
	...
	public wsdlGetSalaryPeriodLockStatusResponse wsdlGetSalaryPeriodLockStatus(wsdlGetSalaryPeriodLockStatusRequest request)
	{
	...
	public wsdlGetLeaveApplicationsResponse wsdlGetLeaveApplications(wsdlGetLeaveApplicationsRequest request)
	{
		return base.Channel.wsdlGetLeaveApplications(request);
	}

	public wsdlGetDeletedLeaveApplicationsResponse wsdlGetDeletedLeaveApplications(wsdlGetDeletedLeaveApplicationsRequest request)
	{
		return base.Channel.wsdlGetDeletedLeaveApplications(request);
	}

	public wsdlGetLeaveApplicationsV2Response wsdlGetLeaveApplicationsV2(wsdlGetLeaveApplicationsV2Request request)
	{
	...
	public wsdlGetSchedulesForAllUnitsResponse wsdlGetSchedulesForAllUnits(wsdlGetSchedulesForAllUnitsRequest request)
	{
		return base.Channel.wsdlGetSchedulesForAllUnits(request);
	}

	public wsdlGetDeletedSchedulesResponse wsdlGetDeletedSchedules(wsdlGetDeletedSchedulesRequest request)
	{
	...
	public wsdlGetShiftCategoriesResponse wsdlGetShiftCategories(wsdlGetShiftCategoriesRequest request)
	{
	...
	public wsdlGetOvertimeMethodsResponse wsdlGetOvertimeMethods(wsdlGetOvertimeMethodsRequest request)
	{
		return base.Channel.wsdlGetOvertimeMethods(request);
	}

	public wsdlGetDeletedEmployeesResponse wsdlGetDeletedEmployees(wsdlGetDeletedEmployeesRequest request)
	{
		return base.Channel.wsdlGetDeletedEmployees(request);
	}

	public wsdlReverseTransactionsResponse wsdlReverseTransactions(wsdlReverseTransactionsRequest request)
	{
	...
	public wsdlGetAgreementTemplatesResponse wsdlGetAgreementTemplates(wsdlGetAgreementTemplatesRequest request)
	{
	...
	public wsdlDeleteSalaryCompensationsResponse wsdlDeleteSalaryCompensations(wsdlDeleteSalaryCompensationsRequest request)
	{
		return base.Channel.wsdlDeleteSalaryCompensations(request);
	}

	public wsdlUpdateSalaryCompensationsResponse wsdlUpdateSalaryCompensations(wsdlUpdateSalaryCompensationsRequest request)
	{
		return base.Channel.wsdlUpdateSalaryCompensations(request);
	}

	public wsdlGetSalaryCompensationsResponse wsdlGetSalaryCompensations(wsdlGetSalaryCompensationsRequest request)
	{
		return base.Channel.wsdlGetSalaryCompensations(request);
	}

	public wsdlGetEligibilityRulesResponse wsdlGetEligibilityRules(wsdlGetEligibilityRulesRequest request)
	{
		return base.Channel.wsdlGetEligibilityRules(request);
	}

	public wsdlUpdateEligibilityRulesResponse wsdlUpdateEligibilityRules(wsdlUpdateEligibilityRulesRequest request)
	{
		return base.Channel.wsdlUpdateEligibilityRules(request);
	}

	public wsdlDeleteEligibilityRulesResponse wsdlDeleteEligibilityRules(wsdlDeleteEligibilityRulesRequest request)
	{
		return base.Channel.wsdlDeleteEligibilityRules(request);
	}

	public wsdlUpdateStandardBankHolidaysResponse wsdlUpdateStandardBankHolidays(wsdlUpdateStandardBankHolidaysRequest request)
	{
		return base.Channel.wsdlUpdateStandardBankHolidays(request);
	}

	public wsdlgetStandardBankHolidaysResponse wsdlgetStandardBankHolidays(wsdlgetStandardBankHolidaysRequest request)
	{
		return base.Channel.wsdlgetStandardBankHolidays(request);
	}

	public wsdlGetAgreementTemplatesV2Response wsdlGetAgreementTemplatesV2(wsdlGetAgreementTemplatesV2Request request)
	{
		return base.Channel.wsdlGetAgreementTemplatesV2(request);
	}

	public wsdlGetAgreementTemplatesSalaryTypesResponse wsdlGetAgreementTemplatesSalaryTypes(wsdlGetAgreementTemplatesSalaryTypesRequest request)
	{
	...
	public wsdlGetEmployeePortraitResponse wsdlGetEmployeePortrait(wsdlGetEmployeePortraitRequest request)
	{
		return base.Channel.wsdlGetEmployeePortrait(request);
	}

	public wsdlGetAgreementInfoByDateResponse wsdlGetAgreementInfoByDate(wsdlGetAgreementInfoByDateRequest request)
	{
	...
	public wsdlUpdateEmployeePortraitsResponse wsdlUpdateEmployeePortraits(wsdlUpdateEmployeePortraitsRequest request)
	{
		return base.Channel.wsdlUpdateEmployeePortraits(request);
	}

	public wsdlGetBaseScheduleRolledoutHoursResponse wsdlGetBaseScheduleRolledoutHours(wsdlGetBaseScheduleRolledoutHoursRequest request)
	{
	...
	public wsdlUpdateManualSalariesResponse wsdlUpdateManualSalaries(wsdlUpdateManualSalariesRequest request)
	{
	...
	public wsdlGetActiveAndAbsenceHoursResponse wsdlGetActiveAndAbsenceHours(wsdlGetActiveAndAbsenceHoursRequest request)
	{
		return base.Channel.wsdlGetActiveAndAbsenceHours(request);
	}

	public wsdlUpdateAgreementsV2Response wsdlUpdateAgreementsV2(wsdlUpdateAgreementsV2Request request)
	{
	...
	public wsdlUpdateEmployeeAttachmentsResponse wsdlUpdateEmployeeAttachments(wsdlUpdateEmployeeAttachmentsRequest request)
	{
	...
	public wsdlGetSkillCategoriesResponse wsdlGetSkillCategories(wsdlGetSkillCategoriesRequest request)
	{
	...
	public wsdlUpdateEmployeeSkillsResponse wsdlUpdateEmployeeSkills(wsdlUpdateEmployeeSkillsRequest request)
	{
	...
	public wsdlScheduleRequestDenyResponse wsdlScheduleRequestDeny(wsdlScheduleRequestDenyRequest request)
	{
		return base.Channel.wsdlScheduleRequestDeny(request);
	}

	public wsdlScheduleRequestApproveResponse wsdlScheduleRequestApprove(wsdlScheduleRequestApproveRequest request)
	{
		return base.Channel.wsdlScheduleRequestApprove(request);
	}

	public wsdlUpdateTimeTrackersResponse wsdlUpdateTimeTrackers(wsdlUpdateTimeTrackersRequest request)
	{
		return base.Channel.wsdlUpdateTimeTrackers(request);
	}

	public wsdlGetTimeTrackerListResponse wsdlGetTimeTrackerList(wsdlGetTimeTrackerListRequest request)
	{
		return base.Channel.wsdlGetTimeTrackerList(request);
	}

	public wsdlGetTimeTrackersBalanceResponse wsdlGetTimeTrackersBalance(wsdlGetTimeTrackersBalanceRequest request)
	{
		return base.Channel.wsdlGetTimeTrackersBalance(request);
	}

	public wsdlGetFirstToExpireTimeTrackersBalanceResponse wsdlGetFirstToExpireTimeTrackersBalance(wsdlGetFirstToExpireTimeTrackersBalanceRequest request)
	{
