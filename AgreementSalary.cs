...
public class AgreementSalary
{
    ...
    {
        get { return hourlySalaryFieldSpecified; }
        set { hourlySalaryFieldSpecified = value; }
    }
    ...
    {
        get { return monthlyHoursDivisorField; }
        set { monthlyHoursDivisorField = value; }
    }

    [SoapIgnore]
    public bool monthlyHoursDivisorSpecified
    {
        get { return monthlyHoursDivisorFieldSpecified; }
        set { monthlyHoursDivisorFieldSpecified = value; }
    }
}
