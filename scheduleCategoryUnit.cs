...
public class scheduleCategoryUnit
{
    ...
    {
        get { return externalUnitIdField; }
        set { externalUnitIdField = value; }
    }

    public int unitId
    {
        get { return unitIdField; }
        set { unitIdField = value; }
    }

    [SoapIgnore]
    public bool unitIdSpecified
    {
        get { return unitIdFieldSpecified; }
        set { unitIdFieldSpecified = value; }
    }

    public bool visibleInWebpunch
    {
        get { return visibleInWebpunchField; }
        set { visibleInWebpunchField = value; }
    }
}
