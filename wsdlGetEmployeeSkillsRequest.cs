...
[MessageContract(WrapperName = "wsdlGetEmployeeSkills", WrapperNamespace = "uri:FlexForce", IsWrapped = true)]
public class wsdlGetEmployeeSkillsRequest
{
	...
	public wsdlGetEmployeeSkillsRequest(string apiKey, int employeeId, string employeeBadgeNo, int employeeGroupId, int employeeSectionId, int skillCategoryId)
	{
		this.apiKey = apiKey;
