...
[MessageContract(WrapperName = "wsdlGetAgreementTemplatesSalaryTypes", WrapperNamespace = "uri:FlexForce", IsWrapped = true)]
public class wsdlGetAgreementTemplatesSalaryTypesRequest
{
	...
	public wsdlGetAgreementTemplatesSalaryTypesRequest(string apiKey, GetAgreementTemplatesSalaryTypesRequest GetAgreementTemplatesSalaryTypesRequest)
	{
		this.apiKey = apiKey;
