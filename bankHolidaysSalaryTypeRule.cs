...
public class bankHolidaysSalaryTypeRule
{
    ...
    {
        get { return hasWorkRequirementField; }
        set { hasWorkRequirementField = value; }
    }

    public int workRequirement
    {
        get { return workRequirementField; }
        set { workRequirementField = value; }
    }

    public bool hasShiftRequirement
    {
        get { return hasShiftRequirementField; }
        set { hasShiftRequirementField = value; }
    }

    public int shiftRequirement
    {
        get { return shiftRequirementField; }
        set { shiftRequirementField = value; }
    }

    public int leaveTypeId
    {
        get { return leaveTypeIdField; }
        set { leaveTypeIdField = value; }
    }

    public bool hasAlternateSalary
    {
        get { return hasAlternateSalaryField; }
        set { hasAlternateSalaryField = value; }
    }

    public decimal alternateAmount
    {
        get { return alternateAmountField; }
        set { alternateAmountField = value; }
    }

    public int alternateStCode
    {
        get { return alternateStCodeField; }
        set { alternateStCodeField = value; }
    }

    public string alternateFromTime
    {
        get { return alternateFromTimeField; }
        set { alternateFromTimeField = value; }
    }

    public int alternateFromType
    {
        get { return alternateFromTypeField; }
        set { alternateFromTypeField = value; }
    }

    public string alternateToTime
    {
        get { return alternateToTimeField; }
        set { alternateToTimeField = value; }
    }

    public int alternateToType
    {
        get { return alternateToTypeField; }
        set { alternateToTypeField = value; }
    }

    public bool replaceBaseSalaries
    {
        get { return replaceBaseSalariesField; }
        set { replaceBaseSalariesField = value; }
    }

    public bool replaceUTSalaries
    {
        get { return replaceUTSalariesField; }
        set { replaceUTSalariesField = value; }
    }

    public bool replaceATSalaries
    {
        get { return replaceATSalariesField; }
        set { replaceATSalariesField = value; }
    }

    public bool replaceOTSalaries
    {
        get { return replaceOTSalariesField; }
        set { replaceOTSalariesField = value; }
    }

    public string leaveReasons
    {
        get { return leaveReasonsField; }
        set { leaveReasonsField = value; }
    }

    public bool replaceSickLeaveSalaries
    {
        get { return replaceSickLeaveSalariesField; }
        set { replaceSickLeaveSalariesField = value; }
    }
