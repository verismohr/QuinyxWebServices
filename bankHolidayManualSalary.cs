...
public class bankHolidayManualSalary
{
    ...
    {
        get { return salTypeStCode1Field; }
        set { salTypeStCode1Field = value; }
    }

    public int functionType
    {
        get { return functionTypeField; }
        set { functionTypeField = value; }
    }

    public int timeIntervalType
    {
        get { return timeIntervalTypeField; }
        set { timeIntervalTypeField = value; }
    }

    public decimal multiFactor
    {
        get { return multiFactorField; }
        set { multiFactorField = value; }
    }

    public int salTypeStCode2
    {
        get { return salTypeStCode2Field; }
        set { salTypeStCode2Field = value; }
    }

    public int ruleCondition
    {
        get { return ruleConditionField; }
        set { ruleConditionField = value; }
    }

    public int ruleOperator
    {
        get { return ruleOperatorField; }
        set { ruleOperatorField = value; }
    }

    public int ruleSalaryTypeStCode
    {
        get { return ruleSalaryTypeStCodeField; }
        set { ruleSalaryTypeStCodeField = value; }
    }

    public decimal ruleWorkedHrs
    {
        get { return ruleWorkedHrsField; }
        set { ruleWorkedHrsField = value; }
    }
    ...
    {
        get { return minMinutesField; }
        set { minMinutesField = value; }
    }

    public decimal maxMinutes
    {
        get { return maxMinutesField; }
        set { maxMinutesField = value; }
    }

    public string refType
    {
        get { return refTypeField; }
        set { refTypeField = value; }
    }
    ...
    {
        get { return parentRuleIdField; }
        set { parentRuleIdField = value; }
    }

    public bool inheritParent
    {
        get { return inheritParentField; }
        set { inheritParentField = value; }
    }
