...
public class getPayrollV2Request
{
    ...
    public bool attest
    {
        get { return attestField; }
        set { attestField = value; }
    }

    public string pSalType
    {
        get { return pSalTypeField; }
        set { pSalTypeField = value; }
    }

    public bool empInUnitOnly
    {
        get { return empInUnitOnlyField; }
        set { empInUnitOnlyField = value; }
    }
    ...
    {
        get { return isTransferingToPayrollField; }
        set { isTransferingToPayrollField = value; }
    }

    [SoapIgnore]
    public bool isTransferingToPayrollSpecified
    {
        get { return isTransferingToPayrollFieldSpecified; }
        set { isTransferingToPayrollFieldSpecified = value; }
    }

    public int approvedSalaryStatus
    {
        get { return approvedSalaryStatusField; }
        set { approvedSalaryStatusField = value; }
    }

    [SoapIgnore]
    public bool approvedSalaryStatusSpecified
    {
        get { return approvedSalaryStatusFieldSpecified; }
        set { approvedSalaryStatusFieldSpecified = value; }
    }
    ...
    {
        get { return costCalculationTypeField; }
        set { costCalculationTypeField = value; }
    }

    [SoapIgnore]
    public bool costCalculationTypeSpecified
    {
        get { return costCalculationTypeFieldSpecified; }
        set { costCalculationTypeFieldSpecified = value; }
    }
    ...
    {
        get { return includeStCodeField; }
        set { includeStCodeField = value; }
    }

    [SoapIgnore]
    public bool includeStCodeSpecified
    {
        get { return includeStCodeFieldSpecified; }
        set { includeStCodeFieldSpecified = value; }
    }
}
