...
[MessageContract(WrapperName = "wsdlGetPayrollRaw", WrapperNamespace = "uri:FlexForce", IsWrapped = true)]
public class wsdlGetPayrollRawRequest
{
	...
	public wsdlGetPayrollRawRequest(string apiKey, string fromDate, string toDate, int attest, string pSalType)
	{
		this.apiKey = apiKey;
