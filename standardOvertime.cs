...
public class standardOvertime
{
    ...
    {
        get { return firstHoursField; }
        set { firstHoursField = value; }
    }

    public int firstType
    {
        get { return firstTypeField; }
        set { firstTypeField = value; }
    }

    public string firstBeg
    {
        get { return firstBegField; }
        set { firstBegField = value; }
    }

    public string firstEnd
    {
        get { return firstEndField; }
        set { firstEndField = value; }
    }

    public int isAdditionalSalaryType
    {
        get { return isAdditionalSalaryTypeField; }
        set { isAdditionalSalaryTypeField = value; }
    }
