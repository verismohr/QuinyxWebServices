...
public class UpdateEmployeeSkill
{
    ...
    {
        get { return addSkillsField; }
        set { addSkillsField = value; }
    }

    [SoapIgnore]
    public bool addSkillsSpecified
    {
        get { return addSkillsFieldSpecified; }
        set { addSkillsFieldSpecified = value; }
    }

    public JobSkill[] jobSkills
    {
        get { return jobSkillsField; }
        set { jobSkillsField = value; }
    }
