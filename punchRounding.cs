...
public class punchRounding
{
    ...
    {
        get { return punchPartField; }
        set { punchPartField = value; }
    }

    public int insideShift
    {
        get { return insideShiftField; }
        set { insideShiftField = value; }
    }

    [SoapIgnore]
    public bool insideShiftSpecified
    {
        get { return insideShiftFieldSpecified; }
        set { insideShiftFieldSpecified = value; }
    }

    public int roundingRule
    {
        get { return roundingRuleField; }
        set { roundingRuleField = value; }
    }

    [SoapIgnore]
    public bool roundingRuleSpecified
    {
        get { return roundingRuleFieldSpecified; }
        set { roundingRuleFieldSpecified = value; }
    }
