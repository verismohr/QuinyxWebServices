...
public class searchOption
{
    ...
    public int[] unitIds
    {
        get { return unitIdsField; }
        set { unitIdsField = value; }
    }

    public string[] extUnitIds
    {
        get { return extUnitIdsField; }
        set { extUnitIdsField = value; }
    }

    public int includeSalariesOptions
    {
        get { return includeSalariesOptionsField; }
        set { includeSalariesOptionsField = value; }
    }

    [SoapIgnore]
    public bool includeSalariesOptionsSpecified
    {
        get { return includeSalariesOptionsFieldSpecified; }
        set { includeSalariesOptionsFieldSpecified = value; }
    }

    public string[] unitGroups
    {
        get { return unitGroupsField; }
        set { unitGroupsField = value; }
    }

    public int[] costCentres
    {
        get { return costCentresField; }
        set { costCentresField = value; }
    }

    public string[] extCostCentres
    {
        get { return extCostCentresField; }
        set { extCostCentresField = value; }
    }

    public int[] sectionIds
    {
        get { return sectionIdsField; }
        set { sectionIdsField = value; }
    }

    public string[] extSectionIds
    {
        get { return extSectionIdsField; }
        set { extSectionIdsField = value; }
    }

    public int[] staffCategories
    {
        get { return staffCategoriesField; }
        set { staffCategoriesField = value; }
    }
    ...
    {
        get { return includeNotFullyApprovedField; }
        set { includeNotFullyApprovedField = value; }
    }

    [SoapIgnore]
    public bool includeNotFullyApprovedSpecified
    {
        get { return includeNotFullyApprovedFieldSpecified; }
        set { includeNotFullyApprovedFieldSpecified = value; }
    }
    ...
    {
        get { return isPreliminaryFieldSpecified; }
        set { isPreliminaryFieldSpecified = value; }
    }

    public bool lockSalaryPeriod
    {
        get { return lockSalaryPeriodField; }
        set { lockSalaryPeriodField = value; }
    }

    [SoapIgnore]
    public bool lockSalaryPeriodSpecified
    {
        get { return lockSalaryPeriodFieldSpecified; }
        set { lockSalaryPeriodFieldSpecified = value; }
    }

    public bool uploadFileToServer
    {
        get { return uploadFileToServerField; }
        set { uploadFileToServerField = value; }
    }

    [SoapIgnore]
    public bool uploadFileToServerSpecified
    {
        get { return uploadFileToServerFieldSpecified; }
        set { uploadFileToServerFieldSpecified = value; }
    }
}
