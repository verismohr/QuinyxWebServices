...
public class Mail
{
    ...
    {
        get { return sendToManagerTypeField; }
        set { sendToManagerTypeField = value; }
    }
    ...
    {
        get { return attachmentsArePayslipsField; }
        set { attachmentsArePayslipsField = value; }
    }

    [SoapIgnore]
    public bool attachmentsArePayslipsSpecified
    {
        get { return attachmentsArePayslipsFieldSpecified; }
        set { attachmentsArePayslipsFieldSpecified = value; }
    }

    public int allowfromPersIdOutsideOfUnit
    {
        get { return allowfromPersIdOutsideOfUnitField; }
        set { allowfromPersIdOutsideOfUnitField = value; }
    }

    [SoapIgnore]
    public bool allowfromPersIdOutsideOfUnitSpecified
    {
        get { return allowfromPersIdOutsideOfUnitFieldSpecified; }
        set { allowfromPersIdOutsideOfUnitFieldSpecified = value; }
    }

    public int isMarkedAsImportant
    {
        get { return isMarkedAsImportantField; }
        set { isMarkedAsImportantField = value; }
    }

    [SoapIgnore]
    public bool isMarkedAsImportantSpecified
    {
        get { return isMarkedAsImportantFieldSpecified; }
        set { isMarkedAsImportantFieldSpecified = value; }
    }
