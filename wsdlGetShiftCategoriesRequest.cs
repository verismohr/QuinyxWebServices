...
[MessageContract(WrapperName = "wsdlGetShiftCategories", WrapperNamespace = "uri:FlexForce", IsWrapped = true)]
public class wsdlGetShiftCategoriesRequest
{
	...
	public wsdlGetShiftCategoriesRequest(string apiKey, string lastModified, bool includeTags, bool includeSkills)
	{
		this.apiKey = apiKey;
