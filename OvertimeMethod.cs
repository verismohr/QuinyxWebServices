...
public class OvertimeMethod
{
    ...
    {
        get { return periodTypeFieldSpecified; }
        set { periodTypeFieldSpecified = value; }
    }
    ...
    {
        get { return periodLengthFieldSpecified; }
        set { periodLengthFieldSpecified = value; }
    }
    ...
    {
        get { return countUpwardsField; }
        set { countUpwardsField = value; }
    }

    [SoapIgnore]
    public bool countUpwardsSpecified
    {
        get { return countUpwardsFieldSpecified; }
        set { countUpwardsFieldSpecified = value; }
    }

    public int thresholdType
    {
        get { return thresholdTypeField; }
        set { thresholdTypeField = value; }
    }

    [SoapIgnore]
    public bool thresholdTypeSpecified
    {
        get { return thresholdTypeFieldSpecified; }
        set { thresholdTypeFieldSpecified = value; }
    }

    public decimal thresholdHours
    {
        get { return thresholdHoursField; }
        set { thresholdHoursField = value; }
    }

    [SoapIgnore]
    public bool thresholdHoursSpecified
    {
        get { return thresholdHoursFieldSpecified; }
        set { thresholdHoursFieldSpecified = value; }
    }

    public int thresholdLength
    {
        get { return thresholdLengthField; }
        set { thresholdLengthField = value; }
    }

    [SoapIgnore]
    public bool thresholdLengthSpecified
    {
        get { return thresholdLengthFieldSpecified; }
        set { thresholdLengthFieldSpecified = value; }
    }

    [SoapElement(DataType = "date")]
    public DateTime thresholdStartDate
    {
        get { return thresholdStartDateField; }
        set { thresholdStartDateField = value; }
    }

    [SoapIgnore]
    public bool thresholdStartDateSpecified
    {
        get { return thresholdStartDateFieldSpecified; }
        set { thresholdStartDateFieldSpecified = value; }
    }

    public int otLevelType
    {
        get { return otLevelTypeField; }
        set { otLevelTypeField = value; }
    }

    [SoapIgnore]
    public bool otLevelTypeSpecified
    {
        get { return otLevelTypeFieldSpecified; }
        set { otLevelTypeFieldSpecified = value; }
    }

    public otLevel[] otLevels
    {
        get { return otLevelsField; }
        set { otLevelsField = value; }
    }
}
